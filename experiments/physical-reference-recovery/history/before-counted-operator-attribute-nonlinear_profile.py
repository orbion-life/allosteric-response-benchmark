...
from model import ROOT, analytic_gaussian, build_model, contract, energies, grid_shape, protocol, runtime_metadata
...
def run(output, faces, h):
    ...
    for t in model['times']:
        ...
        K_cheb.append(contract(F.T, evolved))
        meta['time'] = float(t)
