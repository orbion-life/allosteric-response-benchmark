...
def run(output, faces, h):
    ...
    receipt = dict(status='COMPLETE', runtime=runtime, protocol_sha256=hashlib.sha256((ROOT/'protocol.json').read_bytes()).hexdigest(),
                   ...
                   stationarity_residual=stationarity, csr_stencil_relative_action_error=relative_error,
