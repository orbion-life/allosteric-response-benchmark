...
Writes only beside this script. The refinement envelope is an empirical
...
def main():
    ...
    independent=read_npz(HERE/'independent-control-moments.npz')
    ...
    (HERE/'nonlinear-results-check.json').write_text(json.dumps(receipt,indent=2,allow_nan=False)+'\n')
